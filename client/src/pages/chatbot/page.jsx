        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-green-800">DigiGreen</span>
            </Link>
            <div className="hidden md:flex items-center space-x-8">
              <Link href="/explore" className="text-green-700 hover:text-green-900 font-medium transition-colors">
                Explore
              </Link>
              <Link href="/scanner" className="text-green-700 hover:text-green-900 font-medium transition-colors">
                Scanner
              </Link>
              <Link
                href="/chatbot"
              ...
              <Link href="/stations" className="text-green-700 hover:text-green-900 font-medium transition-colors">
                Stations
              </Link>
              <Link href="/marketplace" className="text-green-700 hover:text-green-900 font-medium transition-colors">
                Marketplace
              </Link>
              <Link href="/tips" className="text-green-700 hover:text-green-900 font-medium transition-colors">
                Tips
              </Link>
            </div>
            <Button className="bg-green-600 hover:bg-green-700 text-white">Start Scanning</Button>
          </div>
        </div>
      </nav>
                ...
                {quickQuestions.map((question, index) => {
                  ...
                  return (
                    <Button
                      key={index}
                      variant="ghost"
                      className="w-full text-left justify-start h-auto p-3 hover:bg-green-50 text-green-700"
